 ...
 *
 * $Id: voip.h 18518 2010-12-06 09:08:46Z mgo $
 */
...
/*! \fn int nbd_voip_callhistory_flush (char const *list)
...
/*! \fn int voip_manage_missed_calls(char* call)
    \brief manage the activation/deactivation of missed calls
 */
