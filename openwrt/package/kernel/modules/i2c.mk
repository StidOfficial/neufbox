...
I2C_OCTEON_TWSI_MODULES:=\
  CONFIG_I2C_OCTEON_TWSI:drivers/i2c/busses/i2c-octeon_twsi

define KernelPackage/i2c-octeon-twsi
  $(call i2c_defaults,$(I2C_OCTEON_TWSI_MODULES),59)
  SUBMENU:=$(I2C_MENU)
  TITLE:=Octeon I2C bus
  DEPENDS:=@TARGET_octeon +kmod-i2c-algo-bit
endef

define KernelPackage/i2c-octeon-twsi/description
 Kernel module for I2C Octeon bus.
endef

$(eval $(call KernelPackage,i2c-octeon-twsi))
