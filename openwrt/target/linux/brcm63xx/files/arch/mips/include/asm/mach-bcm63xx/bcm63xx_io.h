 ...
 */
#define BCM_PCMCIA_COMMON_BASE_PA	(0x1f000000)
#define BCM_PCMCIA_COMMON_SIZE		(1 * 1024 * 1024)
#define BCM_PCMCIA_COMMON_END_PA	(BCM_PCMCIA_COMMON_BASE_PA +	\
					 BCM_PCMCIA_COMMON_SIZE - 1)

#define BCM_PCMCIA_ATTR_BASE_PA		(0x1f200000)
#define BCM_PCMCIA_ATTR_SIZE		(1 * 1024 * 1024)
#define BCM_PCMCIA_ATTR_END_PA		(BCM_PCMCIA_ATTR_BASE_PA +	\
					 BCM_PCMCIA_ATTR_SIZE - 1)

#define BCM_PCMCIA_IO_BASE_PA		(0x1f080000)
#define BCM_PCMCIA_IO_SIZE		(64 * 1024)
#define BCM_PCMCIA_IO_END_PA		(BCM_PCMCIA_IO_BASE_PA +	\
					BCM_PCMCIA_IO_SIZE - 1)

#define BCM_PCI_MEM_BASE_PA		(0x11000000)
#define BCM_PCI_MEM_SIZE		(16 * 1024 * 1024)
#define BCM_PCI_MEM_END_PA		(BCM_PCI_MEM_BASE_PA +		\
					BCM_PCI_MEM_SIZE - 1)

#define BCM_PCI_IO_BASE_PA		(0x13000000)
...
#define BCM_CB_MEM_BASE_PA		(0x12000000)
#define BCM_CB_MEM_SIZE			(16 * 1024 * 1024)
#define BCM_CB_MEM_END_PA		(BCM_CB_MEM_BASE_PA +		\
					BCM_CB_MEM_SIZE - 1)


/*
 * Internal registers are accessed through KSEG1 or KSEG3
 */
...
#define bcm_readq(a)	(*(volatile unsigned long long *)	BCM_REGS_VA(a))
...
#define bcm_writeq(v, a) (*(volatile unsigned long long *) BCM_REGS_VA((a)) = (v))

/*
 * IO helpers to access register set for current CPU
 */
#define bcm_rset_readb(s, o)	bcm_readb((CKSEG1|bcm63xx_regset_address(s)) + (o))
#define bcm_rset_readw(s, o)	bcm_readw((CKSEG1|bcm63xx_regset_address(s)) + (o))
#define bcm_rset_readl(s, o)	bcm_readl((CKSEG1|bcm63xx_regset_address(s)) + (o))
#define bcm_rset_readq(s, o)	bcm_readq((CKSEG1|bcm63xx_regset_address(s)) + (o))
#define bcm_rset_writeb(s, v, o)	bcm_writeb((v), \
					(CKSEG1|bcm63xx_regset_address(s)) + (o))
#define bcm_rset_writew(s, v, o)	bcm_writew((v), \
					(CKSEG1|bcm63xx_regset_address(s)) + (o))
#define bcm_rset_writel(s, v, o)	bcm_writel((v), \
					(CKSEG1|bcm63xx_regset_address(s)) + (o))
#define bcm_rset_writeq(s, v, o)	bcm_writeq((v), \
					(CKSEG1|bcm63xx_regset_address(s)) + (o))
...
#define bcm_perf_readq(o)	bcm_rset_readq(RSET_PERF, (o))
#define bcm_perf_writel(v, o)	bcm_rset_writel(RSET_PERF, (v), (o))
#define bcm_perf_writeq(v, o)	bcm_rset_writeq(RSET_PERF, (v), (o))
