...
#define TAGINFO1_LEN 50                /* Length of vendor information field1 in tag */
...
struct bcm_tag {
	...
	char information1[TAGINFO1_LEN];       // 142-191: Compilation and related information (not generated/used by OpenWRT)
