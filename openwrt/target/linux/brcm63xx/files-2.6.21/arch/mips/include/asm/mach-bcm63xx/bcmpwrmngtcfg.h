...
#define PWRMNGT_CFG_PARAM_ALL_MASK               0x0004FFFF
#define PWRMNGT_CFG_DEF_PARAM_MASK               0x0004FFFF  /* Parameters for which the defaults exist */
#elif defined(CHIP_6368)
#define PWRMNGT_CFG_MAX_PARAMS                   13
#define PWRMNGT_CFG_PARAM_ALL_MASK               0x00004FFF
#define PWRMNGT_CFG_DEF_PARAM_MASK               0x00004FFF  /* Parameters for which the defaults exist */
#elif defined(CHIP_6816) || defined(CONFIG_BCM96816)
#define PWRMNGT_CFG_MAX_PARAMS                   13
#define PWRMNGT_CFG_PARAM_ALL_MASK               0x0001FFFF
#define PWRMNGT_CFG_DEF_PARAM_MASK               0x0001FFFF  /* Parameters for which the defaults exist */
#endif
...
#else /* for 6368 & 6816 */
#define PWRMNGT_CFG_PARAM_ETHPHY0_MASK             0x00000800
   ui32                  phy0;
#define PWRMNGT_CFG_PARAM_ETHPHY1_MASK             0x00001000
   ui32                  phy1;
#define PWRMNGT_CFG_PARAM_ETHPHY2_MASK             0x00002000
   ui32                  phy2;
#define PWRMNGT_CFG_PARAM_ETHPHY3_MASK             0x00004000
   ui32                  phy3;
#endif /* CHIP_6358 */

#if defined(CHIP_6816) || defined(CONFIG_BCM96816)
#define PWRMNGT_CFG_PARAM_MOCA_MASK                0x00008000
   ui32                  moca;
#define PWRMNGT_CFG_PARAM_GPON_MASK                0x00010000
   ui32                  gpon;
#endif /* CHIP_6816 */
