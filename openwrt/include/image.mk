...
SQUASHFS3_OPTS += -b 65536 $(SQUASHFS_OPTS)
...
ifneq ($(CONFIG_TARGET_ROOTFS_INITRAMFS),)
  ...
  ifneq ($(CONFIG_TARGET_ROOTFS_SQUASHFS),)
    define Image/mkfs/squashfs
		...
		$(if $(USE_SQUASHFS3), \
		$(STAGING_DIR_HOST)/bin/fakeroot sh -c "$(PLATFORM_DIR)/image/mkdevices.sh $(TARGET_DIR) && $(MKSQUASHFS_CMD) $(TARGET_DIR) $(KDIR)/root.squashfs -noappend -all-root $(SQUASHFS3_OPTS)",\
