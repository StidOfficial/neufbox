...
#define RSASIG_LEN 40   	       /* Length of RSA Signature in tag */
#define TAGINFO1_LEN 10                /* Length of vendor information field1 in tag */
...
struct bcm_tag {
	...
	char inactiveFlag[INACTIVEFLAG_LEN];   // 140-141: Unused at present
        char rsa_signature[RSASIG_LEN];        // 142-181: RSA Signature (unused at present; some vendors may use this)
	char information1[TAGINFO1_LEN];       // 182-191: Compilation and related information (not generated/used by OpenWRT)
